...
export default function Dashboard() {
  ...
  function handleTitle() {
    ...
    if (bookmarkedActive) return "Bookmarked Movies";
    if (homeActive) return "Recommended for you";
    if (seriesActive) return "TV Series";
  }
  useEffect(() => {
    const results = filteredMovies.filter((value) =>
  ...
  if (localStorage.getItem("authDetails"))
    return (
      <div className="  bg-[#10141E] absolute  lg:gap-[30px]  lg:flex   sm:p-[25px] lg:py-[32px] ">
        <NextTopLoader
          color="#2299DD"
          ...
          <nav className="flex gap-[20px] sm:gap-[40px] items-center lg:flex-col">
            ...
            <svg
              ...
              onClick={() => {
                ...
                setFilteredMovies(data.filter((movie) => movie.isBookmarked));
                setSeriesActive(false);
                setMoviesActive(false);
                setHomeActive(false);
              }}
        ...
        <main className="p-[16px] flex flex-col gap-[24px] ">
          ...
          {homeActive && searchValue === "" && (
            <div className=" w-full ">
              ...
              <section className="flex w-full lg:gap-[40px] gap-[16px] py-[10px] relative ">
                <div className="movies-wrapper w-full overflow-x-scroll scrollbar-hide flex lg:gap-[40px] gap-[16px]py-[10px]">
                  {trendingData.map((movie, index) => {
                    return (
                      <div
                        className="movie-container z-[] lg:w-[470px] w-[320px] group  h-[140px] md:w-[470px] md:h-[230px] rounded-[8px] flex flex-col items-center gap-[4px] p-[16px] justify-end"
                        key={index}
                        style={{
                          backgroundImage: `url(${
                            windowWidth >= 1024
                        ...
                        <div
                          onClick={() => {
                            ...
                            if (movie == currentMovie) {
                              currentMovie.isBookmarked == true;
                            }
                          }}
                          className=" absolute right-[10px] top-[10px] z-[999]"
                        >
                          <svg
                            className=""
                            xmlns="http://www.w3.org/2000/svg"
                ...
                ? filteredMovies.map((movie, index) => {
                    return (
                      ...
                      >
                        <div
                          style={{
                            backgroundImage: `url(${handleThumbnailSize(
                              movie
                            )})`,
                            backgroundRepeat: "no-repeat",
                            backgroundSize: "cover",
