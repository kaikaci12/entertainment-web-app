                ...
                {trendingData.map((movie, index) => {
                  return (
                    <div key={index} className="relative flex-shrink-0">
                      <div
                        className=" lg:w-[470px] w-[320px] group  h-[140px] md:w-[470px] md:h-[230px] rounded-[8px] flex flex-col items-center gap-[4px] p-[16px] "
                        style={{
                          backgroundImage: `url(${
                            windowWidth >= 1024
                      ...
                      >
                        ...
                        <div
                          ...
                          className="cursor-pointer absolute right-[10px] top-[10px] z-[999]"
                        >
                          <svg
                            className=""
                            xmlns="http://www.w3.org/2000/svg"
