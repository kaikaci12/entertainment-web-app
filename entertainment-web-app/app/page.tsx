...
export default function Home() {
  ...
  return (
    <div className="w-full h-full   bg-fixed lg:gap-[30px] lg:flex  bg-[#10141E] sm:p-[25px] lg:py-[32px] ">
      ...
      <main className="p-[16px] flex flex-col gap-[24px] ">
        ...
        <section className="flex w-full lg:gap-[40px] gap-[16px] overflow-x-auto   py-[10px] ">
